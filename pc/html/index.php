...
<main id="main">
  ...
  <article id="news">
      ...
      <li class="item">
        <a href="https://neoforet.co.kr/pr/media/view?seq=38&page=1">
          <div class="textBox">
            ...
            <p class="article">무림의 친환경 경영 및 플라스틱을 대체하는 '네오포레' 시리즈<br />(출처: 단디뉴스)</p>
          </div>
        </a>
      </li>
      <li class="item">
        <a href="https://neoforet.co.kr/pr/media/view?seq=37&page=1">
          <div class="textBox">
            ...
            <p class="article">'2021년 ESG평가'서 무림, 한솔 A등급, 중소형 제지사 C등급<br />(출처: 머니투데이)</p>
          </div>
        </a>
      </li>
      <li class="item">
        <a href="https://neoforet.co.kr/pr/media/view?seq=36&page=1">
          <div class="textBox">
            ...
            <p class="article">무림, 종이 빨대 부착용 비닐도 친환경 종이로 개발<br />(출처:아시아경제)</p>
          </div>
        </a>
      </li>
    </ul>
    ...
    <div class="btns center">
      <a href="#" class="btn large transition"><span>네오포레 소식 더보기</span></a>
    </div>
  </article>
  <!--news end-->
  <div id="cs">
